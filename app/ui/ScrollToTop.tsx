...
const ScrollToTop = () => {
  ...
  return (
    <button
      ...
      } fixed bottom-0 right-2 md:bottom-6 md:right-5  z-20 w-7 h-7 md:w-12 md:h-12 rounded-t-sm md:rounded-full text-[#fff] bg-gradient-to-r from-fruit-salad-600 to-lima-400 transition duration-1000 ease-in `}
    >
